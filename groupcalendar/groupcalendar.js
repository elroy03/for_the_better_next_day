...
function addSCD (doMonth, day, column) {
    ...
    CalArray = CalendarData["byUser"][1]["Calendar"];
    ...
    CalArray = CalendarData["byUser"][2]["Calendar"];
    ...
    CalArray = CalendarData["byUser"][3]["Calendar"];
