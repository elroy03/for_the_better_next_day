...
function addNewTable (column) {
    schedulewrap.style.visibility = "visible";
    var n = document.getElementById("butt");
    n.addEventListener("click", 
        function (){
            var sctit = document.getElementById("sctit").value;
            var sctimer1 = document.getElementById("sctimer1").value;
            var sctimer2 = document.getElementById("sctimer2").value;

            var p1 = document.createElement("p");
            p1.innerHTML = sctit +sctimer1 + "~"+sctimer2;
            if(p1.innerHTML !="~"){
            ...
            schedulewrap.style.visibility = "hidden";
